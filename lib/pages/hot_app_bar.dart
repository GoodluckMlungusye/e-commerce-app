...
import 'package:e_commerce/pages/app_bar_provider.dart';

class HotApplicationBar extends StatefulWidget {

  @override
  State<HotApplicationBar> createState() => _HotApplicationBarState();
}

class _HotApplicationBarState extends State<HotApplicationBar> {


  @override
  void initState(){
    final appBarProvider = Provider.of<AppBarProvider>(context,listen: false);
    appBarProvider.getButton();
    super.initState();
